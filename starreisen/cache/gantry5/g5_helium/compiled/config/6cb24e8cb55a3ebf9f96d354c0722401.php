...
return [
    ...
    'checksum' => 'ad15008abcea624a494118ce3106dc15',
    'files' => [
        'templates/g5_helium/custom/config/19' => [
            'assignments' => [
                'file' => 'templates/g5_helium/custom/config/19/assignments.yaml',
                'modified' => 1611633108
            ],
            'index' => [
                'file' => 'templates/g5_helium/custom/config/19/index.yaml',
                'modified' => 1618187929
            ],
            'layout' => [
                'file' => 'templates/g5_helium/custom/config/19/layout.yaml',
                'modified' => 1618187929
            ]
        ],
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'messages' => [
                    'system-messages-5453' => 'System Messages'
                ],
                'logo' => [
                    'logo-6641' => 'Logo / Image',
                    'logo-7253' => 'Logo / Image'
                ],
                'menu' => [
                    'menu-7116' => 'Menu'
                ],
                ...
                'copyright' => [
                    'copyright-8122' => 'Copyright'
                ],
                'horizontalmenu' => [
                    'horizontalmenu-2330' => 'Horizontal Menu'
                ],
                'totop' => [
                    'totop-7524' => 'To Top'
                ],
                'mobile-menu' => [
                    'mobile-menu-5731' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
                'default' => [
                    ...
                    'footer' => 'footer',
                    'offcanvas' => 'offcanvas',
                    'system-messages-5453' => 'system-messages-7972',
                    'logo-6641' => 'logo-9608',
                    'menu-7116' => 'menu-6409',
                    'social-8829' => 'social-3171',
                    'logo-7253' => 'logo-9571',
                    'copyright-8122' => 'copyright-1736',
                    'horizontalmenu-2330' => 'horizontalmenu-9034',
                    'totop-7524' => 'totop-8670',
                    'mobile-menu-5731' => 'mobile-menu-5697'
                ]
            ]
        ],
        'layout' => [
