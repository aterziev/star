...
return [
    ...
    'checksum' => '4317ebb56ef1c720c9f86b7c627144d0',
    'files' => [
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'messages' => [
                    'system-messages-1979' => 'System Messages'
                ],
                'logo' => [
                    'logo-3683' => 'Logo / Image',
                    'logo-1318' => 'Logo / Image'
                ],
                'menu' => [
                    'menu-4694' => 'Menu'
                ],
                ...
                'module' => [
                    'position-module-2977' => 'Module Instance'
                ],
                'position' => [
                    'position-position-3856' => 'Sidebar'
                ],
                'copyright' => [
                    'copyright-4925' => 'Copyright'
                ],
                'horizontalmenu' => [
                    'horizontalmenu-5269' => 'Horizontal Menu'
                ],
                'totop' => [
                    'totop-8805' => 'To Top'
                ],
                'mobile-menu' => [
                    'mobile-menu-7737' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
                'default' => [
                    ...
                    'footer' => 'footer',
                    'offcanvas' => 'offcanvas',
                    'system-messages-1979' => 'system-messages-7972',
                    'logo-3683' => 'logo-9608',
                    'menu-4694' => 'menu-6409',
                    'social-9194' => 'social-3171',
                    'position-position-3856' => 'position-position-3949',
                    'logo-1318' => 'logo-9571',
                    'copyright-4925' => 'copyright-1736',
                    'horizontalmenu-5269' => 'horizontalmenu-9034',
                    'totop-8805' => 'totop-8670',
                    'mobile-menu-7737' => 'mobile-menu-5697'
                ]
            ]
        ],
        'layout' => [
