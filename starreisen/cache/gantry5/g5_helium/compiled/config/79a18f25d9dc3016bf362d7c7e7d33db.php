...
return [
    ...
    'timestamp' => 1619172813,
    'checksum' => 'f7a5e2534370a4dc91f92ac919e4860e',
    'files' => [
        'templates/g5_helium/custom/config/16' => [
            'assignments' => [
                'file' => 'templates/g5_helium/custom/config/16/assignments.yaml',
                'modified' => 1611633108
            ],
            'index' => [
                'file' => 'templates/g5_helium/custom/config/16/index.yaml',
                'modified' => 1618187929
            ],
            'layout' => [
                'file' => 'templates/g5_helium/custom/config/16/layout.yaml',
                'modified' => 1618187929
            ]
        ],
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'messages' => [
                    'system-messages-9917' => 'System Messages'
                ],
                'logo' => [
                    'logo-3777' => 'Logo / Image',
                    'logo-1514' => 'Logo / Image'
                ],
                'menu' => [
                    'menu-2038' => 'Menu'
                ],
                ...
                'copyright' => [
                    'copyright-6687' => 'Copyright'
                ],
                'horizontalmenu' => [
                    'horizontalmenu-4130' => 'Horizontal Menu'
                ],
                'totop' => [
                    'totop-1967' => 'To Top'
                ],
                'mobile-menu' => [
                    'mobile-menu-8137' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
                'default' => [
                    ...
                    'footer' => 'footer',
                    'offcanvas' => 'offcanvas',
                    'system-messages-9917' => 'system-messages-7972',
                    'logo-3777' => 'logo-9608',
                    'menu-2038' => 'menu-6409',
                    'social-9657' => 'social-3171',
                    'logo-1514' => 'logo-9571',
                    'copyright-6687' => 'copyright-1736',
                    'horizontalmenu-4130' => 'horizontalmenu-9034',
                    'totop-1967' => 'totop-8670',
                    'mobile-menu-8137' => 'mobile-menu-5697'
                ]
            ]
        ],
        'layout' => [
